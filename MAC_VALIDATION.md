...
- [ ] 新規DBがschema v10で作成され、`PRAGMA integrity_check`が`ok`になる
- [ ] legacy JSONからschema v10へThoughtを失わず一度だけ移行する
...
- [ ] AI Reply／Daily Summary／Persona Postの成功・失敗・cancel・retryがschema v10へ記録される
